...
/***/ "F:\\mygithub2\\hxl-maps\\common\\request\\api.js":
/*!***************************************************!*\
  !*** F:/mygithub2/hxl-maps/common/request/api.js ***!
  \***************************************************/
/*! no static exports found */
...
var _request = _interopRequireDefault(__webpack_require__(/*! ./request.js */ "F:\\mygithub2\\hxl-maps\\common\\request\\request.js"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // 引入文件
...
module.exports = {
  ...
  // 修改昵称
  editnicknameapi: function editnicknameapi(apidata) {
    return new Promise(function (resolve, reject) {
      _request.default.
      post({
...
/***/ "F:\\mygithub2\\hxl-maps\\common\\request\\request.js":
/*!*******************************************************!*\
  !*** F:/mygithub2/hxl-maps/common/request/request.js ***!
  \*******************************************************/
/*! no static exports found */
...
var Request = function () {
  ...
  return (/*#__PURE__*/function () {
      ...
      function _class() {var _this = this;_classCallCheck(this, _class);
        ...
        this.interceptors = {
          request: function request(fn) {
            _this[interceptors].request = fn;
          },
          response: function response(fn) {
            _this[interceptors].response = fn;
          } };

      }

      // 获取配置数据
      _createClass(_class, [{ key: "getConfig", value: function getConfig() {
          return this.config;
        }
        ...
        // get请求
      }, { key: "get", value: function get() {var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          var newConfig = this[commonConfig](config, "get");

          return this[commonRequest](newConfig);
        }

        // post请求
      }, { key: "post", value: function post() {var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          var newConfig = this[commonConfig](config, "post");

          return this[commonRequest](newConfig);
        }

        // 停止运行
      }, { key: "stop", value: function stop(e) {
      ...
      }, { key: setContentType, value: function value(type) {
          var str = "";
        ...
        /**
           ...
           * @return: 完整的绝对路径
           */ }, { key:
        joinUrl, value: function value(url) {
          var beforeUrlHasSlash = this.config.url.lastIndexOf('/') + 1 == this.config.url.length;
        ...
        /**
           ...
           */ }, { key:
        commonConfig, value: function value(config, method) {
          var newConfig = {};
          var url = this[joinUrl](config.url || "");
        ...
        // 公共请求方法, 支持对对象中内嵌函数或Promise
      }, { key: commonRequest, value: function value(config) {var _this2 = this;
          var _request = function _request() {
            if (typeof _this2[interceptors].request === "function") {
              var ret = _this2[interceptors].request(config);
          ...
          var _response = function _response(res) {
            if (typeof _this2[interceptors].response === "function") {
              var ret = _this2[interceptors].response(res);
          ...
          var _check = function _check(res) {
            var newRes = _response(res);
          ...
          return function () {
            ...
            var example,
            obj = new Promise(function (resolve, reject, ppp) {
              example = uni.request(_objectSpread({},
              config, {
                success: function success(res) {
                  var newRes = _check(res);
        ...
        /**
           ...
           */ }, { key:
        error, value: function value(str) {
...
// 设置全局唯一
if (!global.$request) global.$request = new Request();var _default =
...
"use strict";
/* WEBPACK VAR INJECTION */(function(createApp) {__webpack_require__(/*! uni-pages */ "F:\\mygithub2\\hxl-maps\\pages.json");
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ "./node_modules/@dcloudio/vue-cli-plugin-uni/packages/mp-vue/dist/mp.runtime.esm.js"));
var _App = _interopRequireDefault(__webpack_require__(/*! ./App */ "F:\\mygithub2\\hxl-maps\\App.vue"));

var _store = _interopRequireDefault(__webpack_require__(/*! ./store */ "F:\\mygithub2\\hxl-maps\\store\\index.js"));

var _api = _interopRequireDefault(__webpack_require__(/*! @/common/request/api.js */ "F:\\mygithub2\\hxl-maps\\common\\request\\api.js"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {_defineProperty(target, key, source[key]);});}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
/***/ "F:\\mygithub2\\hxl-maps\\main.js?{\"page\":\"pages%2Fhome%2Fhome\"}":
/*!********************************************************************!*\
  !*** F:/mygithub2/hxl-maps/main.js?{"page":"pages%2Fhome%2Fhome"} ***!
  \********************************************************************/
/*! no static exports found */
...
"use strict";
/* WEBPACK VAR INJECTION */(function(createPage) {__webpack_require__(/*! uni-pages */ "F:\\mygithub2\\hxl-maps\\pages.json");

var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ "./node_modules/@dcloudio/vue-cli-plugin-uni/packages/mp-vue/dist/mp.runtime.esm.js"));
var _home = _interopRequireDefault(__webpack_require__(/*! ./pages/home/home.vue */ "F:\\mygithub2\\hxl-maps\\pages\\home\\home.vue"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
createPage(_home.default);
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ "./node_modules/@dcloudio/uni-mp-weixin/dist/index.js")["createPage"]))

/***/ }),

/***/ "F:\\mygithub2\\hxl-maps\\pages.json":
/*!****************************************!*\
  !*** F:/mygithub2/hxl-maps/pages.json ***!
  \****************************************/
/*! no static exports found */
...
/***/ "F:\\mygithub2\\hxl-maps\\store\\actions.js":
/*!**********************************************!*\
  !*** F:/mygithub2/hxl-maps/store/actions.js ***!
  \**********************************************/
/*! no static exports found */
...
/***/ "F:\\mygithub2\\hxl-maps\\store\\getters.js":
/*!**********************************************!*\
  !*** F:/mygithub2/hxl-maps/store/getters.js ***!
  \**********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var getters = {
  ...
  // 所有订单状态
  orderStatusObj: function orderStatusObj(state) {
    return state.all.orderStatusObj;
  },
  // 所有订单状态 颜色
  orderStatusColorObj: function orderStatusColorObj(state) {
    return state.all.orderStatusColorObj;
  },
  // 所有订单删除按钮显示
  orderDeleteObj: function orderDeleteObj(state) {
    return state.all.orderDeleteObj;
  },
  // 法律文件
  lawTypeObj: function lawTypeObj(state) {
...
/***/ "F:\\mygithub2\\hxl-maps\\store\\index.js":
/*!********************************************!*\
  !*** F:/mygithub2/hxl-maps/store/index.js ***!
  \********************************************/
/*! no static exports found */
...
var _qqmapsdk = _interopRequireDefault(__webpack_require__(/*! ./modules/qqmapsdk */ "F:\\mygithub2\\hxl-maps\\store\\modules\\qqmapsdk.js"));
var _user = _interopRequireDefault(__webpack_require__(/*! ./modules/user */ "F:\\mygithub2\\hxl-maps\\store\\modules\\user.js"));
var _all = _interopRequireDefault(__webpack_require__(/*! ./modules/all */ "F:\\mygithub2\\hxl-maps\\store\\modules\\all.js"));
var _getters = _interopRequireDefault(__webpack_require__(/*! ./getters */ "F:\\mygithub2\\hxl-maps\\store\\getters.js"));
var _actions = _interopRequireDefault(__webpack_require__(/*! ./actions */ "F:\\mygithub2\\hxl-maps\\store\\actions.js"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ "F:\\mygithub2\\hxl-maps\\store\\modules\\all.js":
/*!**************************************************!*\
  !*** F:/mygithub2/hxl-maps/store/modules/all.js ***!
  \**************************************************/
/*! no static exports found */
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var all = {
...
all;exports.default = _default;

/***/ }),

/***/ "F:\\mygithub2\\hxl-maps\\store\\modules\\qqmapsdk.js":
/*!*******************************************************!*\
  !*** F:/mygithub2/hxl-maps/store/modules/qqmapsdk.js ***!
  \*******************************************************/
/*! no static exports found */
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var qqmapsdk = {
  // namespaced: true, // 命名空间
  state: {
...
/***/ "F:\\mygithub2\\hxl-maps\\store\\modules\\user.js":
/*!***************************************************!*\
  !*** F:/mygithub2/hxl-maps/store/modules/user.js ***!
  \***************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var user = {
  ...
  mutations: {
    // 设置登陆本地缓存
    SETLOGINSTATE: function SETLOGINSTATE(state, provider) {
    ...
    // 修改本地缓存
    EDITUSERMES: function EDITUSERMES(state, provider) {
      state.hxl_UserMess = provider;
      uni.setStorageSync('hxl_UserMess', provider);
    },
    // 设置货物类型
    SETGOODSTYPELIST: function SETGOODSTYPELIST(state, GoodsTypeList) {
      state.GoodsTypeList = GoodsTypeList;
    },
    // 设置包装方式
    SETPACKAGETYPELIST: function SETPACKAGETYPELIST(state, PackageTypeList) {
      state.PackageTypeList = PackageTypeList;
    },
    // 设置全局城市
    SETMYCITY: function SETMYCITY(state, mycity) {
      uni.setStorageSync('mycity', mycity);
      state.mycity = mycity;
    },
    // 设置全局城市坐标
    SETMYLOCATION: function SETMYLOCATION(state, myLocation) {
      uni.setStorageSync('myLocation', myLocation);
      state.myLocation = myLocation;
    },
    // 退出清空所有
    LOGINOUT: function LOGINOUT(stata) {
      state.user_id = null;
